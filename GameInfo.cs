...
namespace GeometryFriendsAgents
{
    internal class GameInfo
    {
        ...
        public const int SQUARE_RADIUS = 50; 
        ...
        public const int MAX_VELOCITY_X = 200;
        public const int MAX_VELOCITY_Y = 20;

        public const float JUMP_VELOCITY = 437f;
        public const float FALL_VELOCITY = 0;
